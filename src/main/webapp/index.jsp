...
<body>
<div id="container">
    <iframe id="header" src="pages/header.jsp" width="980" height="136" frameborder="0" scrolling="no"></iframe>
    <form action="userServlet" method="post">
        ...
        <div class="login">
            <ul class="form f_l">
                ...
                <li class="a_c"><button type="submit" style="background: url(images/login.gif) no-repeat;height: 30px;width: 75px;" aria-label="FirstBigButton"></button></li>
                <!--错误信息显示地方 -->
            ...
            <ul class="aside f_l">
                ...
                <li class="a_c"><a href="./pages/register.jsp" target="_parent"><img src="./images/registernow.gif"
                                                                             alt="现在就注册"/></a></li>
                <ul class="reged">
                    <li class="regpic regpic5">您已经是会员？<a href="./pages/login.jsp" target="_parent">由此登入</a></li>
                    <li class="regpic regpic6">繁体中文用户由此<a href="./pages/register.jsp" target="_parent">注册</a></li>
                </ul>
            </ul>
        </div>
    </form>

    <iframe id="footer" src="./pages/footer.htm" width="980" height="136" frameborder="0" scrolling="no"></iframe>
</div> <!--container end-->
