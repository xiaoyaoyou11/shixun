...
<body>
	<div id="header">
			<img class="logo_img" alt="" src="/imges/logo.gif" >
			...
			<c:if test="${not empty sessionScope.cart.items}">
				...
				<c:forEach items="${sessionScope.cart.items}" var="entry">
					<tr>
						...
						<td><a class="deleteItem" href="cartServlet?action=deleteCartItem&id=${entry.value.id}">删除</a></td>
					</tr>
				</c:forEach>
			</c:if>
		</table>
