<%@ page import="com.guimei.zxj.dao.impl.ProductDaoImpl" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ page import="com.guimei.zxj.dao.ProductDao" %>
<%@ page import="com.guimei.zxj.service.ProductService" %>
<%@ page import="com.guimei.zxj.service.impl.ProductServiceImpl" %><%--
