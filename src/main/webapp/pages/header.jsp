...
<body>
		<div id="header">
			...
			<%
		request.setAttribute("catName1","家用电器");
		request.setAttribute("catName2","手机数码");
		request.setAttribute("catName3","日用百货");
		request.setAttribute("catName4","书籍");
			%>
  		<div class="nav f_l w100p">
  			<ul>
				...
				<li><a href="./order.jsp" target="_parent">&nbsp;我的订单</a></li>
